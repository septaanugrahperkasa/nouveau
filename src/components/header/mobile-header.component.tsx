...
const MobileHeader = () => {
  ...
  return (
    <header className={css["header"]}>
      <div className={css["notice"]}>Free shipping on orders over $75</div>
      <nav className={css["navigation"]}>
        ...
        <aside ref={dropdownMenuRef} className={css["sidebar-menu"]}>
          <ul className={css["menu-items"]}>
            ...
            <li>
              <Link to="/shop">SHOP SKINCARE</Link>
            </li>
            <li>
              <Link to="/skincare-routine">SKINCARE ROUTINE</Link>
            </li>
            <li>
              <Link to="/blog">BEAUTY JOURNAL</Link>
            </li>
            <li>
              <Link to="/about">OUR STORY</Link>
            </li>
            <li>
              <Link to="/wishlist">SKINCARE WISHLIST</Link>
            </li>
            <li>
              <Link to="/skin-consultation">FREE SKIN CONSULTATION</Link>
            </li>
          </ul>
        </aside>
      </nav>
