      ...
      <div className={css["shipping-returns-body"]}>
        <div className={css["section"]}>
          ...
          <p>
            ...
            <a href="mailto:hello@Nouveau.com">hello@Nouveau.com</a>. We
        ...
        <div className={css["section"]}>
          ...
          same day shipping, please email hello@Nouveau.com.
        </div>
        <div className={css["section"]}>
          ...
          consignee authorizes Nouveau to import the goods on his/her
          behalf. Further, the consignee/buyer agrees Nouveau may
