  ...
  return (
    <div className={"page-container"}>
      ...
      <div className={css["body-container"]}>
        <p>
          Welcome to Nouveau Please read these terms of service
        ...
        <p>
          Nouveau sells organic and natural skincare products. We take
        ...
        <p>
          Nouveau offers free shipping on all orders. If you are not
        ...
        <p>
          ...
          You agree to respect the intellectual property rights of Nouveau
        ...
        <p>
          Nouveau is not liable for any damages, including but not
        ...
        <p>
          Nouveau reserves the right to modify or update these terms of
