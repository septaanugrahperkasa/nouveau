...
const About = () => {
  return (
    <div className={`page-container`}>
      <h1 className={`page-heading`}>About Nouveau</h1>
      ...
      <div className={`${css["main-about"]}`}>
        ...
        <div className={`${css["about-description"]}`}>
          At Nouveau Co, we believe that true beauty comes from within and
          ...
          and appreciate your body, look no further than Nouveau Our
