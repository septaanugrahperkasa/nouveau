  ...
  return (
    <div className={"page-container"}>
      ...
      <div className={css["body-container"]}>
        <p>
          Nouveau is committed to protecting the privacy of our
        ...
        <p>
          Nouveau collects the following personal information from
          customers:
        </p>
        ...
        <p>
          Nouveau does not share personal information with any third
        ...
        <p>
          Nouveau takes the protection of customer information
        ...
        <p>
          Nouveau does not use cookies or other tracking technologies on
          our website.
        </p>
        ...
        <p>
          Nouveau does not knowingly collect personal information from
        ...
        <p>
          Nouveau reserves the right to modify or update this privacy
        ...
        <p>
          ...
          please contact us. Thank you for choosing Nouveau for your
          skincare needs.
        </p>
      </div>
    </div>
